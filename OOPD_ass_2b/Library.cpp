...
#include <iostream>
#include <string>
#include "LibraryItem.h"  // Assuming LibraryItem is the base class for Book, Journals, and PublicationRank
#include "User.h"         // Assuming you have a User class for teachers and students
#include "Book.h"
#include "Journals.h"
